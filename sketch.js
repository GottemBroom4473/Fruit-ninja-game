...
var faca,fruta ,monstro,grupoFruta,grupoMonstro, placar,r,frutaAleatoria, posicao;
...
function draw() {
  ...
  if(estadoJogo===JOGAR){
    ...
    faca.y=World.mouseY;
    faca.x=World.mouseX;
  // esta certo mas quando a fruta vem da esquerda ela volta 
...
function frutas(){
  if(World.frameCount%80===0){
    ...
    fruta.velocityX=-7
    if(placar >= 4){
       fruta.velocityX = fruta.velocityX + 2;
       }
    }
    else
    {
